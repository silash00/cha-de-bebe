...
/**
 * Cascata das seções dentro do papel. O atraso entre filhos é pequeno de
 * propósito: acima de ~80ms a página parece lenta para carregar em vez de
 * parecer que está se montando.
 */
export const PAPEL = {
  hidden: {},
